...
resource "aws_instance" "application" {
  ...
  user_data                   = var.user_data_configuration == "module" ? data.cloudinit_config.config.rendered : (var.user_data_configuration == "user_provided" ? var.additional_user_data_script : (var.user_data_configuration == "none" ? null : null))
